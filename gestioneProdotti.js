  ...
  try {
    ...
    data.forEach((dato) => {
      ...
      modifica.addEventListener("click", function () {
        ...
        formModificaProdotto.scrollIntoView({ behavior: 'smooth', block: 'start' });
        let modifiedNameInput=document.getElementById("modified-name");
        modifiedNameInput.value=nomeProdotto.innerText;
        let modifiedDescriptionInput=document.getElementById("modified-description");
      ...
      elimina.addEventListener("click", function() {
        ...
        formEliminaProdotto.scrollIntoView({ behavior: 'smooth', block: 'start' })
